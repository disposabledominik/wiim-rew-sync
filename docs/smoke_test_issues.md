...
| 85 | Diagnostics panel "Send" button does nothing (raw_command_requested not wired) | FIXED | NO | `9c6de2d`, `ff4597d`, `d1e2ce5` | Connected signal; thread-safe via progress_update; scrollable layout; caps auto-populated; log Refresh button |
...
| 87 | Sidebar preset/profile load doesn't work when wizard state is incomplete | FIXED | NO | `9c6de2d`, `ff4597d`, `d1e2ce5` | QuickSetupDialog always shows source for PEQ; sets wizard current_step=REVIEW after load to prevent step_changed override |
