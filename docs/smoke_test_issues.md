...
| 87 | Sidebar preset/profile load doesn't work when wizard state is incomplete | FIXED | NO | `9c6de2d`, `ff4597d`, `d1e2ce5`, `8499e83`, `e386bfc` | QuickSetupDialog: checks completed_steps (not stale state); clears source on device re-select; marks all prior steps; navigates to Review |
