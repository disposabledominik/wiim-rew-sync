...
| 93 | Pull from REW: subsequent pull after preset load uses stale filters from preset | FIXED | NO | `7478e7c` | Same root cause as #92 — the combined list was re-split incorrectly; explicit L/R lists now preserved through the push path |
